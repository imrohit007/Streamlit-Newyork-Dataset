...
#st.title("Hello dev..!! Stremlit is amazing")

# for documentation st.markdown

#st.markdown('### This is a crazy platform')
...
st.markdown('This application is a streamlit dashboard that can be used to'
    'analyze motor vehicle collisions in New York City 🗽'
)
